...
parser.add_argument('-i', '--input', type=str,
                    help='path of input file.', default='data/example/inp1')
parser.add_argument('--log', type=str, help='log file.', default='data/log')
parser.add_argument('-v', type=int, help='visual result.',
...
cmd = 'lib/find-2D-crystal/src/find2D.x 0<{} 1>{} 2>&1'.format(
    input_file, log_file)
...
for xsf_file in xsf_list:
    ...
    prefix, result = cluster_from_file(
        '{}/{}'.format(input_dir, xsf_file), method='KMeans_method', plot_image=plot_image)
